...
function generateQuoteHTML(quote, items) {
    ...
    // אם יש לכם שדה bank/iban וכו' ב־quote – אפשר לשלוף פה
...
<head>
  ...
  <style>
    ...
    /* גרסה כחולה לכרטיסים (כמו הבאנר הכחול) */
    .blue-card {
      background: #eef2ff;
...
<body>
  <div class="sheet">
    <div class="header">
      ...
      <div class="logo">
        <!-- אם יש לכם SVG של הלוגו, הניחו אותו כאן (הדגמה): -->
        <!-- החלף לתוכן ה-SVG שלך, או תמונה base64 -->
       <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="303" height="122" viewBox="0 0 403 122">
          ...
          <!-- אפשר לשים כאן <image xlink:href="data:image/png;base64,...." .../> -->
          <!-- או הגרפיקה הוקטורית עצמה -->
        </svg>
      </div>
    </div>
